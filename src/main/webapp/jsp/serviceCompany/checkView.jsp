                                    	...
                                    	<div class="row" >                               		
	                                    	<div class="col-lg-9">	
		                                    	<div class="form-group">		                                    				                                    		
											    	...
											    	<label  class="col-sm-2 control-label" style="text-align: center">${sc.id }</label>
											    	<label  class="col-sm-2 col-sm-offset-1 control-label" style="text-align: center">uId:</label>											    	
											    	<label  class="col-sm-1 control-label" style="text-align: center">${sc.uId }</label>
											   	</div>	
											   	<hr>
											   	<div class="form-group">
											   	 	<label  class="col-sm-2 control-label" style="text-align: center">姓名：</label>											    	
											    	<label  class="col-sm-2 control-label" style="text-align: center">${sc.name }</label>
													<label  class="col-sm-2 control-label col-sm-offset-1" style="text-align: center">电话：</label>											    	
											    	<label  class="col-sm-2 control-label" style="text-align: center">${sc.phone }</label>					
											   	</div>											   
											   	<hr>  
											   	...
											   	<div class="form-group">
											    	...
											    	<label  class="col-sm-2 control-label" style="text-align: center">${sc.serviceCity }</label>
											    	<label  class="col-sm-2 col-sm-offset-1 control-label" style="text-align: center">地址：</label>											    	
											    	<label  class="col-sm-3 control-label" style="text-align: center">${sc.address }</label>
											   	</div>  
											   	<hr>
											   	<div class="form-group">
											   	 	<label  class="col-sm-2 control-label" style="text-align: center">简介：</label>											    	
											    	<label  class="col-sm-7 control-label" style="text-align: center">${sc.introduce }</label>
											    	
											   	</div>  
											   	<hr>
											   	<div class="form-group">
											   	 	<label  class="col-sm-2 control-label" style="text-align: center">评分：</label>											    	
											    	<label  class="col-sm-2 control-label" style="text-align: center">${sc.grade }</label>
											    	<label  class="col-sm-2 col-sm-offset-1 control-label" style="text-align: center">评分人数：</label>											    	
											    	<label  class="col-sm-3 control-label" style="text-align: center">${sc.gradePeople }</label>
											   	</div>                            		                                        
	                                            <hr>
	                                        </div>
	                                        <div class="col-lg-3" ">
