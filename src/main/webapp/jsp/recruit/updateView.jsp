                                    	...
                                    	<div class="row" >                               		
	                                    	<div class="col-lg-12">
		                                        <div class="form-group">
		                                            <label>标题</label>
		                                            <input class="form-control" name="title" value="${r.title }">		                                            
		                                        </div>
	                                        </div>
	                                        <div class="col-lg-4">
		                                        <div class="form-group">
		                                            <label>发布人</label>
		                                            <input class="form-control" name="author" value="${r.author }">		                                            
		                                        </div>
	                                        </div>
	                                        ...
	                                        <div class="col-lg-12">
		                                        <div class="form-group">
		                                            <label>内容</label>
		                                            <textarea id="content" name="content" rows="20" cols="70">${r.content }</textarea>   
	...
	<script type="text/javascript">
        $(function () {
            ...
            $("#submit").click(function () {            	
                ...
                $.post("recruit.do?method=update", $("#form1").serialize(), function (data) {
                	var result = jQuery.parseJSON(data)
                	if(result.msg=="ok"){
                		alert("提交成功")
                		window.location.href = "recruit.do"; 
	            	}else{
	            		alert("提交失败")
	            	}
                });
