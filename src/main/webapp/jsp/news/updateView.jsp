                                    	...
                                    	<div class="row" >                               		
	                                    	<div class="col-lg-12">
		                                        <div class="form-group">
		                                            <label>标题</label>
		                                            <input class="form-control" name="title" value="${n.title }">		                                            
		                                        </div>
	                                        </div>
	                                        <div class="col-lg-4">
		                                        <div class="form-group">
		                                            <label>作者</label>
		                                            <input class="form-control" name="author" value="${n.author }">		                                            
		                                        </div>
	                                        </div>
	                                        ...
	                                        <div class="col-lg-12">
		                                        <div class="form-group">
		                                            <label>内容</label>
		                                            <textarea id="content" name="content" rows="20" cols="70">${n.content }</textarea>   
	...
	<script type="text/javascript">
        $(function () {
            ...
            $("#submit").click(function () {            	
                ...
                $.post("news.do?method=update", $("#form1").serialize(), function (data) {
