                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	                                ...
	                                <c:forEach var="n" items="${ns }" varStatus="status">
										<tr id="${status.count }">
											<td>${n.id }</td>
											<td >${n.author }</td>
											<td >${n.title }</td>
											...
											<td >
												<input class="btn btn-primary btn-xs" name="mb" id="${n.id }" type="button" value="编辑">
												<input class="btn btn-primary  btn-xs" name="del" id="${n.id }" type="button" value="删除">
											</td>
										</tr>
									</c:forEach> 
                                </tbody>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("input[name='del']").click(function(){
				id = this.id;
				window.location.href="news.do?method=delete&&id="+id; 
			});
