                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" ">
                            <form role="form" action="jzOrder.do?method=review" method="post"> 
                            	<input type="hidden" name="id" value="${jo.id}">
                            	<input type="hidden" name="sId" value="${jo.serverId}">
                            	<input type="hidden" name="uId" value="${jo.jiedanId }">
                            	<input type="hidden" name="dId" value="${jo.id }">
                            	<input type="hidden" name="isCompany" value="${jo.isCompany }">
                            	<div class="row" >                               		
                                  	<div class="col-lg-6">
