                                ...
                                <tbody>
	                                ...
	                                <c:forEach var="jo" items="${jos }" varStatus="status">
										<tr id="${status.count }">
											...
											<td >
												<c:if test="${jo.state == 0}"><a href="jzOrder.do?method=myDelete&&id=${jo.id }"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="取消订单"></a></c:if>
												<c:if test="${jo.state == 1}"><a href="jzOrder.do?method=payAndReFund&&id=${jo.id }&&state=2"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="支付"></a></c:if>
												<c:if test="${jo.state == 2}"><a href="jzOrder.do?method=updateMyState&&id=${jo.id }&&state=4"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="申请退款"></a>
													<a href="jzOrder.do?method=updateMyState&&id=${jo.id }&&state=6"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="确认完成"></a>
												</c:if>
												<c:if test="${jo.state == 3}"><a href="jzOrder.do?method=myDelete&&id=${jo.id }"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="取消订单"></a></c:if>
												<c:if test="${jo.state == 4}"></c:if>
												<c:if test="${jo.state == 5}"><a href="jzOrder.do?method=myDelete&&id=${jo.id }"><input class="btn btn-primary  btn-xs"  id="${jo.id }" type="button" value="删除订单"></a></c:if>
