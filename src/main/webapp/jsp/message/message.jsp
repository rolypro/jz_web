                                ...
                                <tbody>
	                                ...
	                                <c:forEach var="m" items="${ms }" varStatus="status">
										<tr id="${status.count }">
											...
											<td >
												<input class="btn btn-primary btn-xs" name="mb" id="${m.id }" type="button" value="查看详情">
												<input class="btn btn-primary  btn-xs" name="del" id="${m.id }" type="button" value="删除">
											</td>
										</tr>
									</c:forEach> 
                                </tbody>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("input[name='mb']").click(function(){
				id = this.id;
				window.location.href="message.do?method=sub&&id="+id; 
			});
			
			$("input[name='del']").click(function(){
				id = this.id;
				window.location.href="message.do?method=delete&&id="+id; 
			});
