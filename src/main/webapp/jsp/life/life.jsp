                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	                                ...
	                                <c:forEach var="l" items="${ls }" varStatus="status">
										<tr id="${status.count }">
											<td>${l.id }</td>
											<td >${l.author }</td>
											<td >${l.title }</td>
											...
											<td >
												<input class="btn btn-primary btn-xs" name="mb" id="${l.id }" type="button" value="编辑">
												<input class="btn btn-primary  btn-xs" name="del" id="${l.id }" type="button" value="删除">
											</td>
										</tr>
									</c:forEach> 
                                </tbody>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("input[name='mb']").click(function(){
				id = this.id;
				window.location.href="life.do?method=updateView&&id="+id; 
			});
			
			$("input[name='del']").click(function(){
				id = this.id;
				window.location.href="life.do?method=delete&&id="+id; 
			});
