 ...
 <div class="container">
	...
	<div class = "row">
		<div class="col-md-12" style="position: relative; top: 10px">			
			<form role="form" action="message.do?method=insert" method="post">
				<div class="form-group">
					<textarea name="content" style="font-size:16px; border-radius: 5px" cols="140" maxlength="10"></textarea>
					<button type="submit" style="width: 80px" class="btn btn-default">评   论</button>
				</div>
			</form>
			<hr>
		</div>
			...
			<div class="col-md-12 ">
				<div class="panel panel-default">
		            <div class="panel-heading">
		                <h5>评论:<a href="main.do?method=messageById&&id=${m.id }">${m.content }</a></h4>
						<h5>评论者:${m.name }</h5>
						<h5>时间:<fmt:formatDate value="${m.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
		            </div>
	        	</div>
        	</div>
		</c:forEach>
