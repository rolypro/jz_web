...
<body>
 ...
 <div class="container">
	...
	<!-- 这里添加内容 -->
	<div class = "row">
		<input type="hidden" id="id" value="${sc.id }">
		<input type="hidden" id="isCompany" value="1">
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-6"><h4>姓名：${sc.name }</h4></div>
				<div class="col-md-6"><h4>电话：${sc.phone }</h4></div>
			</div>
			<hr>
			<div class="row">
				<div class="col-md-6"><h4>服务城市：${sc.serviceCity }</h4></div>
				<div class="col-md-6"><h4>地址：${sc.address }</h4></div>
			</div>
			<hr>
			<div class="row">
			...
			<hr>
			<div class="row">
				<div class="col-md-12"><h4>个人介绍：${sc.introduce }</h4></div>
			</div>
			<hr>
